/*
  # Add Therapist Role Assignment

  1. New Functions
    - `assign_therapist_role`: Assigns therapist role to user and links them to a specific therapist
  
  2. New Tables
    - `user_therapist_links`: Maps users to their assigned therapist
...
BEGIN
  ...
  -- Create policy (use DROP IF EXISTS and CREATE to avoid IF NOT EXISTS syntax issues)
