/*
  # Fix client_id constraint issues

  1. Changes
    - Makes client_id nullable
    - Adds a check constraint to ensure client_id is not empty when provided
    - Adds an index on client_id for performance
    - Updates any empty client_id values to a default value
*/
