/*
  ...
  1. Database Functions
    - Fix `get_recent_chat_history` function by properly dropping it first
    - Fix `generate_semantic_cache_key` function
    - Fix `get_cached_ai_response` function
    - Fix `cache_ai_response` function
...
CREATE FUNCTION generate_semantic_cache_key(
  p_query_text text,
...
CREATE FUNCTION cache_ai_response(
  p_cache_key text,
  p_query_text text,
