...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_ai_cache_key ON ai_response_cache(cache_key);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_ai_cache_hash ON ai_response_cache(query_hash);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_ai_cache_expires ON ai_response_cache(expires_at);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_ai_cache_created ON ai_response_cache(created_at);
