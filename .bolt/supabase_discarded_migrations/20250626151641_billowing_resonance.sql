...
1. New Approach
  ...
  - Recreate functions with consistent signatures
  - Fix error: "cannot change return type of existing function"
...
DROP FUNCTION IF EXISTS validate_time_interval(time);
