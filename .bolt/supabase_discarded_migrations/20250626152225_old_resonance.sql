...
BEGIN
  ...
  RAISE NOTICE '- test@example.com (password: test123) - User role';
  RAISE NOTICE '- j_eduardo622@yahoo.com (password: admin123) - Admin role';
...
RAISE NOTICE '1. Regular User: test@example.com / test123';
RAISE NOTICE '2. Admin User: j_eduardo622@yahoo.com / admin123';
RAISE NOTICE '';
RAISE NOTICE 'If user creation failed due to auth schema restrictions,';
RAISE NOTICE 'please create these users manually through:';
RAISE NOTICE '1. Supabase Dashboard > Authentication > Users';
RAISE NOTICE '2. Or use the signup form in the application';