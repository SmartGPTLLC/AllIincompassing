-- Apply missing functions from recent migrations
-- This file contains only the essential functions without migration dependencies

-- 1. Chat History Function (from 20250621003423_azure_recipe.sql)
...
-- 2. Semantic Cache Functions (from 20250621003654_black_oasis.sql)
